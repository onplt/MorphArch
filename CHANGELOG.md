...
### Fixed
- **Release Automation:** Corrected release binaries naming pattern in `.github/workflows/release.yml` for simplified fetching.

## [1.2.3] - 2026-03-11

### Changed
- **Documentation & Configuration:** Updated `CLAUDE.md`, `CONTRIBUTING.md`, and `website/docs/installation.md` to reflect the latest state. Adjusted CI/CD configuration in `.github/workflows/ci.yml` and tweaked `clippy.toml` and `Dockerfile`.
...
[1.2.4]: https://github.com/onplt/morpharch/compare/v1.2.3...v1.2.4
[1.2.3]: https://github.com/onplt/morpharch/compare/v1.2.2...v1.2.3
